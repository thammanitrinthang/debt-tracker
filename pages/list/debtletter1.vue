<template><v-card flat>
    <template v-slot:title>
      <div class="mx-right text-h3" style="font-size: 30px; padding: 16px;">การส่งจดหมาย <v-avatar color="red" class="mx-2">
                          ...
                          <v-container>
                              <v-row>
                                  <v-col cols="12" sm="6" md="4">
                                      <v-text-field v-model="editedItem.no" label="ลำดับ" variant="outlined"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                      <v-text-field v-model="editedItem.contract" label="เลขที่สัญญา" variant="outlined"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                      <v-text-field v-model="editedItem.name" label="ชื่อ-นามสกุล" variant="outlined"></v-text-field>
                                  </v-col>
                                  <v-col cols="12" sm="6" md="4">
                                      <v-text-field v-model="editedItem.comments" label="หมายเหตุ" variant="outlined"></v-text-field>
                                  </v-col>
                              </v-row>
                          </v-container>
                      </v-card-text>
